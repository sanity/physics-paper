...
\title{A Learned Latent Algebra for Physical Systems\\ Closed Under Spatial Composition and Time Evolution\thanks{Draft --- work in progress as of 2026-05-08. Source and PDF: \url{https://github.com/sanity/physics-paper}.}}
...
\bibitem[Watters et al.(2019)]{watters2019cobra} N. Watters, L. Matthey, M. Bosnjak, C.~P. Burgess, A. Lerchner. COBRA. \emph{ICML Workshop on Model-Based Reinforcement Learning (MBRL)}, 2019.
\bibitem[Wilson and Kogut(1974)]{wilson1971renormalization} K.~G. Wilson and J. Kogut. The renormalization group and the $\epsilon$ expansion. \emph{Physics Reports}, 12:75--200, 1974.
\end{thebibliography}
